...
from importing import LoadSpectrogramConfig, get_paths_by_file, dvc_load_spectrograms, feast_load_spectrograms
...
@click.option(
    "--importing",
    default="dvc",
    help="Method for fetching training data, dvc or feast",
)
def main(
    epochs: int,
    batch_size: int,
